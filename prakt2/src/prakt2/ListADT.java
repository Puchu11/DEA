...
public void removeAll(T elem); // Balio zehatz baten agerpen guztiak ezabatzen ditu

public T first(); // listako lehen elementua ematen du

public T last(); // listako azken elementua ematen du

public DoubleLinkedList<T> clone();	// Zerrendaren kopia bat itzultzen du (ez du punteroa bikoizten)
